...
function RegionDetailPage() {
  ...
  // Initialize or get scale for current image
  const getCurrentScale = () => {
    return 1; // Always start at zoom level 1
  };
  ...
  const nextImage = (e) => {
    ...
    if (region?.media && region.media.length > 1) {
      ...
      if (transformComponentRef.current) {
        ...
        updateScale(1); // Reset scale to 1
      }
    }
  };
            ...
            <div className="relative w-full h-full max-w-4xl max-h-[90vh] p-4">
              ...
              >
                {({ zoomIn, zoomOut, resetTransform, instance }) => {
                  transformComponentRef.current = instance;
                  return (
                    <>
                      <TransformComponent
